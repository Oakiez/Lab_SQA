...
${CHROME_DRIVER_PATH}     ${CURDIR}${/}ChromeForTesting${/}chrome-win64${/}chromedriver.exe
${URL}                    http://sampleapp.tricentis.com/


*** Test Cases ***
UAT-Lab11-001 Request Vehicle Insurance Quote Success
    [Documentation]    การขอใบเสนอราคาผลิตภัณฑ์สำหรับรถยนต์กรณีทำได้สำเร็จ
...
Open Insurance Main Page
    ...
    ${service}=    Evaluate
    ...    sys.modules["selenium.webdriver.chrome.service"].Service(executable_path=r"${CHROME_DRIVER_PATH}")
